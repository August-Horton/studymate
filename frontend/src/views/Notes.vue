<template>
  <div class="obsidian-workspace">
    ...
    <aside class="sidebar">
      ...
      <div v-if="!searchQuery && activeSidebarTab === 'flashcards'" class="tab-content custom-scroll">
        ...
        <div v-else-if="flashcards.length === 0" style="text-align: center; padding: 40px; color: #999;">
          ...
          <div style="font-size: 15px; font-weight: 500; color: #6b7280; margin-bottom: 8px;">还没有闪卡</div>
          <div style="font-size: 12px; color: #9ca3af;">在笔记中选中文字，点击"制作闪卡"开始吧！</div>
        </div>
        ...
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px;">
          ...
          <div style="display: flex; gap: 8px; align-items: center;">
            <span 
              ...
              style="font-size: 11px; color: #4F46E5; cursor: pointer;" 
    ...
    <van-popup v-model:show="showCreateModal" position="bottom" :style="{ height: '75%' }" round>
      <div style="padding: 24px;">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
          <h3 style="margin: 0; font-size: 18px; color: #111827;">✨ 沉淀新知识</h3>
        ...
        <div style="margin: 16px 0; padding: 0 16px;">
          <p style="font-size: 13px; color: #6b7280; margin-bottom: 8px;">为笔记打上多维标签：</p>
    ...
    >
      <div style="padding: 16px;">
        <van-field 
          ...
          placeholder="请输入新的标题..." 
          border
          style="background-color: #f3f4f6; border-radius: 8px;"
        />
      </div>
    </van-dialog>
    ...
    >
      <div style="padding: 16px;">
        <p style="font-size: 12px; color: #9ca3af; margin-bottom: 12px;">支持多级嵌套，例如：大四/英语/四六级</p>
        <van-field 
    ...
    >
      <div style="padding: 16px;">
        ...
        <div style="font-size: 13px; color: #6b7280; margin-bottom: 8px;">标签</div>
        <div style="display: flex; flex-wrap: wrap; gap: 8px; margin-bottom: 12px;">
          <van-tag 
            v-for="tag in presetTags" 
            :key="tag.name"
    ...
    >
      <div style="padding: 20px 16px; text-align: center;">
        ...
        <div style="display: flex; justify-content: center; background-color: #fef2f2; padding: 12px; border-radius: 8px;">
...
const getPreviewHtml = (markdownStr) => {
  if (!markdownStr) return '<span style="color: #9ca3af;">这里是一片荒芜，还没有写内容...</span>'
...
.fullscreen-wrapper {
  ...
  z-index: 99999;
  background-color: #fafafa; /* 背景颜色交由包装盒负责 */
  display: flex;
  flex-direction: column;
}
...
.raw-editor {
  ...
  line-height: 1.9;
  color: #374151;
  background-color: #f9fafb; /* 淡淡的灰色背景，区别于阅读模式 */
  border: none;
  outline: none;
  resize: none;
}
...
.menu-item:hover { background-color: #f3f4f6; color: #4F46E5; }
